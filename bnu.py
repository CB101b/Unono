...
if needHelp == "y":
  ...
  print('rood0=[1, 0], rood1=[1, 1], rood2=[1, 2], rood3=[1, 3], rood4=[1, 4],  rood5=[1, 5], rood6=[1, 6], rood7=[1, 7], rood8=[1, 8], rood9=[1, 9], rood10 = [1, 10] #pak twee kaarten, green0 = [2, 0], green1 = [2, 1], green2 = [2, 2], green3 = [2, 3], green4 = [2, 4], green5 = [2, 5], green6 = [2, 6], green7 = [2, 7], green8 = [2, 8], green9 = [2, 9], green10 = [2, 10] #pak twee kaarten, blauw0 = [3, 0], blauw1 = [3, 1], blauw2 = [3, 2], blauw3 = [3, 3], blauw4 = [3, 4], blauw5 = [3, 5], blauw6 = [3, 6], blauw7 = [3, 7], blauw8 = [3, 8], blauw9 = [3, 9], blauw10 = [3, 10] #pak twee kaarten, yellow0 = [4, 0], yellow1 = [4, ,1], yellow2 = [4, 2], yellow3 = [4, 3], yellow4 = [4, 4], yellow5 = [4, 5], yellow6 = [4, 6], yellow7 = [4, 7], yellow8 = [4, 8], yellow9 = [4, 9], yellow10 = [4, 10] #pak twee kaarten, wild1 = [5, 0] #pak 2 kaarten en wild2 = [6, 0] #pak 4 kaarten.')
